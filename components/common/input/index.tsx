    ...
    return (
        <div className="relative z-0 w-full">
            <input type={type}
                ...
                placeholder=" "
                className={twMerge("block px-0 w-full text-[16px] leading-6 py-2 bg-transparent border-0 border-b focus:border-black focus:outline-0 focus:ring-0 border-mute appearance-none focus:outline-none peer text-black", inputClassName)}
            />
