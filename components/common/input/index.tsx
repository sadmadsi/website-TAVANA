    ...
    return (
        <div className="relative z-0 w-full">
            ...
            <label htmlFor="floating_standard"
                className={twMerge("absolute text-mute font-bold text-sm duration-300 transform -translate-y-12 top-7 right-0 -z-10 origin-[0] peer-placeholder-shown:-translate-y-5  peer-focus:-translate-y-12", labelClassName)}>
                {label}
            </label>
        </div>
    )
