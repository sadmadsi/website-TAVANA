...
export default function TimeLine() {
    return (
        <div className="flex flex-col sm:bg-[url('/photos/hero-background.jpg')] bg-[url('/photos/hero-background.jpg')] bg-no-repeat bg-right bg-cover sm:bg-center sm:justify-center justify-center h-[794px] sm:mt-[118px] pt-[120px] relative">
