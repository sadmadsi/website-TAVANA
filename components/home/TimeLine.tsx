...
export default function TimeLine() {
    return (
        <div className="flex flex-col sm:bg-[url('/photos/hero-background.png')] bg-[url('/photos/mobile_banner.jpg')] bg-no-repeat bg-center bg-cover sm:bg-center sm:justify-center justify-center h-[794px] mt-[120px] pt-[120px] relative">
