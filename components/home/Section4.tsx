        ...
        <section className="bg-mustard">
            <div className='container py-16 flex sm:flex-row flex-col h-full'>
                <div className='grow flex flex-col justify-between basis-1/2 ml-5'>
                    ...
                    <h2 className='text-justify mt-12 mb-10'>به‌صورت غیرحضوری کد معاملاتی فیزیکی بورس کالا را در<br className="sm:visible hidden" /> کارگزاری توانا دریافت و بدون قرعه‌کشی و پس از انتخاب<br className="sm:visible hidden" /> قیمت، خودروی مدنظرتان را خریداری کنید.</h2>
