        ...
        <div className="bg-[#D9D9D9] text-black py-20" id='section-4'>
            <div className="container py-10 flex flex-col h-full">
                ...
                <div className="lg:grid sm:grid-cols-3 gap-8 mt-32 mb-20 space-y-5 lg:space-y-0">
                    ...
                    <div className="relative z-0 h-[52px]">
                        <input type="text" id="floating_standard" className="block px-0 w-full h-full text-sm text-[#9a9a9a] bg-transparent border-0 border-b focus:border-black focus:outline-0 focus:ring-0 border-[#9a9a9a] appearance-none focus:outline-none peer" placeholder=" " />
                        <label htmlFor="floating_standard" className="absolute text-[#9a9a9a] font-bold text-sm duration-300 transform -translate-y-6 top-5 -z-10 origin-[0] peer-focus:right-0  peer-placeholder-shown:translate-y-0  peer-focus:-translate-y-6">نام شرکت</label>
                    </div>
                    <div className="relative z-0 h-[52px]">
                        <input type="text" id="floating_standard" className="block px-0 w-full h-full text-sm text-[#9a9a9a] bg-transparent border-0 border-b focus:border-black focus:outline-0 focus:ring-0 border-[#9a9a9a] appearance-none focus:outline-none peer" placeholder=" " />
                    ...
                    <div className="relative z-0 h-[52px]">
                        <input type="text" id="floating_standard" className="block px-0 w-full h-full text-sm text-[#9a9a9a] bg-transparent border-0 border-b focus:border-black focus:outline-0 focus:ring-0 border-[#9a9a9a] appearance-none focus:outline-none peer" placeholder=" " />
                        <label htmlFor="floating_standard" className="absolute text-[#9a9a9a] font-bold text-sm duration-300 transform -translate-y-6 top-5 -z-10 origin-[0] peer-focus:right-0  peer-placeholder-shown:translate-y-0  peer-focus:-translate-y-6">توضیحات</label>
                    </div>
                </div >
