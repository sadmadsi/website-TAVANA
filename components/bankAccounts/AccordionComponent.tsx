                ...
                <div className="space-y-3 relative">
                    ...
                    </div>
                    {
                        items.map((account: any) => {
                            return (
                                <div key={account.bank + account.accountNumber} className="border border-black bg-white text-black sm:text-[18px] text-sm font-[600] flex sm:flex-row flex-col sm:py-5 sm:px-2 items-center justify-evenly">
                                    <div className="flex text-right items-center sm:w-[19%] w-full border-b border-b-black sm:border-b-0 py-3 sm:pr-20 px-5">
                                        <div className="flex items-center">
                                            <Image src={`/icons/${account.icon}`} alt={'melli'} height={30} width={30} />
